...
#read -p "Enter your install (Default is 1):" answer #COMMENTATA IN QUANTO DIAMO UNA VERSIONE STAMDARD OBBLIGATORIA (LA DESKTOP FULL) PER EVITARE INPUT
answer=1
case "$answer" in
  1)
...
echo "STEP 6 SKIPPATO IN QUANTO L'AMBIENTE DI ROS VIENE SETTATO SUCCESSIVAMENTE COME COMANDO NEL DOCKERFILE"
